...
program
  ...
  .option('--from-page <n>', 'Start scraping from this page (overrides resume)', parseInt)
  ...
  .action(async (options) => {
    const { source: sourceName, since, maxThreads, maxPages, fromPage, dryRun, resume } = options;
    ...
    console.log(`From page:   ${fromPage || '(resume / page 1)'}`);
