      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Survival-based; pending cases included
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Decided / Pending</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
              {(stats?.decidedCount ?? 0)} / {(stats?.pendingCount ?? 0)}
            </div>
            <p className="text-xs text-muted-foreground">
              Mean of decided cases:&nbsp;
              {stats?.averageWaitingDaysDecided ? `${stats.averageWaitingDaysDecided} days` : '-'}
            </p>
          </CardContent>
        </Card>
