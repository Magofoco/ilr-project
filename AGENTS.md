...
Key files: `packages/db/prisma/schema.prisma`, `apps/worker/src/extraction/extractor.ts` (current version `1.3`), `apps/worker/src/scraper/runner.ts`, `apps/worker/src/sources/immigration-boards.ts`, `apps/api/src/lib/cohort.ts`, `apps/api/src/routes/estimate.ts`, `packages/shared/src/utils/kaplan-meier.ts`.
